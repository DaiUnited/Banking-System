...
namespace DoAn
{
    public partial class NapTien : Form
    {
        ...
        public NapTien(BankCard bankCard, KhachHangForm khachHangForm)
        {
            InitializeComponent();
        ...
        {
            decimal soTienNap = decimal.Parse(txt_TienNap.Text);
            service.NapTien(bankCard.SoThe, soTienNap);
