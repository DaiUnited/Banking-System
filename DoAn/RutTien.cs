...
namespace DoAn
{
    public partial class RutTien : Form
    {
        ...
        public RutTien(BankCard bankCard, KhachHangForm khachHangForm)
        {
            InitializeComponent();
        ...
        {
            decimal soTienRut = decimal.Parse(txt_TienRut.Text);
            service.RutTien(bankCard.SoThe, soTienRut);
